  ...
  render() {
    return (
      <ScrollView style={styles.privacyContainer}>
        ...
        <Text style={styles.content}>We at Beach Tides (“Beach Tides,”, "FE", “we,” “us,” or “our”) created this privacy policy (“Privacy Policy”) because we know that you care about how information you provide to us is used and shared. This Privacy Policy relates to the information collection and use practices of Beach Tides in connection with our website located at www.functionearth.com (the “Site”), and the Service.</Text>
      ...
      <Text style={styles.privacyLargeText}>Beach Tides Blog Content</Text>
      <Text style={styles.content}>We are not responsible for protecting any Personal Information that you post on our blog or on social media web pages associated with Beach Tides. Although we reserve the right to monitor any postings, all Personal Information that is posted on these websites is unprotected and can be seen by anyone with access to the Site.</Text>
